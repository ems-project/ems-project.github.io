...
EMSCH_SAML_IDP_ENTITY_ID='http://keycloack.localhost/realms/elasticms'
...
EMSCH_SAML_IDP_SSO='http://keycloack.localhost/realms/elasticms/protocol/saml'
```

> *IMPORT* For using xDebug change http://keycloack.localhost -> http://localhost:9081
